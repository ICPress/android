...
public class ColorPicker extends View {
    ...
    private View.OnClickListener onColorClickSelected;
    ...
    public float[] colorHSV = new float[] { 0f, 0f, 1f };
    ...
    public ColorPicker(Context context, View.OnClickListener onColorClickSelected) {
        super(context);
        this.onColorClickSelected = onColorClickSelected;
        init();
    }
    ...
    void resetArrowPointerSize(){
       arrowPointerSize =  (int) (paramArrowPointerSize * getWidth()  / 100);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            onColorClickSelected.onClick(this);
