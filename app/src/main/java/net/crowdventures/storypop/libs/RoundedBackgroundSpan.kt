...
class RoundedBackgroundSpan(
    ...
    override fun drawBackground(
        ...
        val width = if (lineNumber == 0) {
            actualWidth - padding //added (- padding) so that first line has rounded corners
        ...
        rect.set(0f, top.toFloat(), shiftRight, bottom.toFloat()) //senad: rect.set(shiftLeft.. before caused left side not being rounded (being cropped)
