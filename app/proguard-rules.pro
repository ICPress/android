...
-keep class net.crowdventures.storypop.room.** { *; }
-keep class net.crowdventures.storypop.composable.** { *; }
-keep class net.crowdventures.storypop.viewmodels.** { *; }
-keep class net.crowdventures.storypop.dto.** { *; }
