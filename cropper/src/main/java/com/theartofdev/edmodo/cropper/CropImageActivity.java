...
public class CropImageActivity extends AppCompatActivity
    implements CropImageView.OnSetImageUriCompleteListener,
        CropImageView.OnCropImageCompleteListener, Toolbar.OnMenuItemClickListener {
...
//    }
    ...
    //toolbar.replaceMenu(R.menu.crop_image_menu);
  ...
  protected Intent getResultIntent(Uri uri, Exception error, int sampleSize) {
    CropImage.ActivityResult result =
        new CropImage.ActivityResult(
            ...
            sampleSize, mCropImageView.isFixAspectRatio(), mCropImageView.isTitleBackgroundImage());
