...
public final class CropImage {
  ...
  public static final class ActivityBuilder {
    ...
    public ActivityBuilder setIsTitleBackgroundImage(boolean isTitleBackgroundImage) {
      mOptions.isTitleBackgroundImage = isTitleBackgroundImage;
      return this;
    }
  ...
  public static final class ActivityResult extends CropImageView.CropResult implements Parcelable {
    ...
    public ActivityResult(
      ...
      super(
          ...
          wholeImageRect,
          rotation,
          sampleSize,isAspectFixed, isTitleBackgroundImage);
    ...
    protected ActivityResult(Parcel in) {
      super(
          ...
          (Rect) in.readParcelable(Rect.class.getClassLoader()),
          in.readInt(),
          in.readInt(), in.readInt() == 1,in.readInt() == 1);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
      ...
      dest.writeInt(getIsAspectFixed()? 1 : 0);
      dest.writeInt(getIsTitleBackgroundImage()? 1:0);
    }
