...
public class CropImageView extends FrameLayout {
  ...
  public CropImageView(Context context, AttributeSet attrs) {
    ...
    mImageView = (ImageView) v.findViewById(R.id.content_title_iv);
  ...
  public boolean isTitleBackgroundImage() {
    return mCropOverlayView.isTitleBackgroundImage();
  }
  ...
  public void setIsTitleBackgroundImage(boolean isTitleBackgroundImage) {
    mCropOverlayView.setIsTitleBackgroundImage(isTitleBackgroundImage);
  }
  ...
  void onImageCroppingAsyncComplete(BitmapCroppingWorkerTask.Result result) {
    ...
    //setProgressBarVisibility(); CONTINUE SHOWING LOADING //SENAD
    ...
    if (listener != null) {
      CropResult cropResult =
          new CropResult(
              ...
              getWholeImageRect(),
              getRotatedDegrees(),
              result.sampleSize,isFixAspectRatio(), isTitleBackgroundImage());
  ...
  public static class CropResult {
    ...
    private final boolean mIsAspectFixed;

    private final boolean mIsTitleBackgroundImage;
    ...
    CropResult(
        ...
        Rect wholeImageRect,
        int rotation,
        int sampleSize, boolean isAspectFixed, boolean isTitleBackgroundImage) {
    ...
    public boolean getIsAspectFixed() {
      return mIsAspectFixed;
    }

    public boolean getIsTitleBackgroundImage() {
